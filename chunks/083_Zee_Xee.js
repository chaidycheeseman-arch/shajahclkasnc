                    ns = St[bt] || {};
                  Be = {
                    book: String(ns.bookName || "").trim() || Ay.book,
                    author: String(ns.author || "").trim() || Ay.author,
                    quote: String(ns.quote || "").trim() || Ay.quote,
                  };
                }
                const Ke = Je === u ? "active" : Je === p ? "exit" : "";
                return e.jsxs(
                  "div",
                  {
                    className: `profile-card ${Ke}`,
                    id: `card-${Je}`,
                    onClick: () => Je === u && g("detail"),
                    children: [
                      e.jsx("button", {
                        type: "button",
                        className: "bookmark",
                        "aria-label": "返回桌面",
                        onClick: (bt) => {
                          (bt.stopPropagation(), typeof t == "function" && t());
                        },
                      }),
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsx("div", {
                            className:
                              "flex justify-between items-baseline mb-2 opacity-60 mt-8",
                            children: e.jsx("span", {
                              className:
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsx("h1", {
                                className:
                                  "serif-display text-3xl leading-[0.9] mb-1 text-black",
                                children: Be.book,
                              }),
                              e.jsxs("p", {
                                className:
                                  "serif-text italic text-gray-500 text-base",
                                children: ["by ", Be.author],
                              }),
                            ],
                          }),
                          e.jsx("div", {
                            style: {
                              ...
                              height: "1px",
                              background:
                                "linear-gradient(to right, #ccc 20%, transparent 0%)",
                          ...
                          e.jsx("div", {
                            ...
                            style: {
                              borderLeft: "3px solid var(--orbit-accent)",
                              paddingLeft: "1rem",
                              margin: "1.8rem 0 1rem",
                            },
                            children: e.jsxs("p", {
                              className:
                                "quote-text serif-text text-lg text-black",
                              children: ['"', Be.quote, '"'],
                            }),
                          }),
                          e.jsxs("div", {
                            className:
                              "flex items-center justify-end gap-3 opacity-80 pt-8",
                            children: [
                              e.jsxs("div", {
                                ...
                                children: [
                                  e.jsx("span", {
                                    className:
                                      "mono text-[9px] text-gray-400 block tracking-widest",
                                    children: "READER",
                                  }),
                                  e.jsx("span", {
                                    className:
                                      "serif-display text-sm text-black",
                                    children: Ne.remark,
                                  }),
                                ],
                              }),
                              e.jsx("div", {
                                className:
                                  "w-8 h-8 border border-gray-100 p-[2px] bg-white",
                                children: e.jsx("img", {
                                  src: Ne.avatar,
                                  alt: Ne.remark,
                                  className:
  ...
  mp = "chat_app_audio_db_v1",
  mg = "chat_app_single_custom_prompt_presets_idb_v1",
  Hee = new Set([
    "chat_app_contacts",
    "chat_app_groups",
    "chat_app_group_colors",
    "chat_app_all_group_settings",
    "chat_app_group_initial_names",
    "chat_app_contacts_tab_order",
    "chat_app_contacts_tab_hidden",
    "chatApp_blocked_friend_requests_v1",
  ]),
  Wee = new Set([
    "chat_app_presets",
    "chat_app_memes",
    "chat_app_meme_categories",
    "chat_app_favorites",
    "chat_app_group_layout_presets",
  ]),
  Yee = new Set([
    "chat_app_user",
    "chat_app_user_presets",
    "chat_app_global_css",
    "chat_app_profile_theme",
    "chat_app_night_mode",
    "chat_app_beautify_custom_presets",
    "chat_app_beautify_custom_active_id",
  ]),
  Vee = new Set([
    "chat_app_system_notification",
    "chat_app_notification_strategy",
    "chat_app_sound_enabled",
    "chat_app_send_sound_key",
    "chat_app_receive_sound_key",
    "chat_app_click_sound_key",
    "chat_app_blocked_invite_ringtone_key",
    "chat_app_click_glow_enabled",
    "chat_app_click_glow_asset",
  ]),
  Jee = new Set([
    "chat_app_phone_recents",
    "chat_app_douyin_memories",
    "chat_app_npc_pool_v1",
    "chat_app_npc_pool_deny_v1",
  ]),
  Kee = new Set([
    "phone_layout_items",
    ...
    "phone_weatherEffect",
    "phone_showStatusBar",
    "phone_showHomeIndicator",
    "phone_showDynamicIsland",
    "phone_themeColor",
    "phone_showPhoneCase",
    "phone_caseColor",
    "phone_caseWidth",
  ...
  qee = new Set([
    "chatApp_groupChatShortcut",
    "chat_app_bg_image",
    "chat_app_debug_group_reply",
    "chat_app_bg_updated",
    "chat_app_icity_beautify_css_story",
    "chat_app_icity_beautify_css_calendar",
    "chat_app_icity_beautify_css_list",
  ]),
  Qee = ["chat_app_icity_", "chat_app_chatList_"];
function Zee(t) {
  return qee.has(t) || Qee.some((s) => t.startsWith(s));
}
function XC(t) {
  return t === "__localStorage_app_patch__"
    ? null
    : t === "mail_app_db_settings" || t === "mail_app_db_files"
      ? "mail"
      : t === mp
        ? "chat_audio"
        : t === mg
          ...
          : t.startsWith("phone_")
            ? Kee.has(t)
              ? "desktop_layout"
              : "system"
            : t.startsWith("device_") ||
                t.startsWith("user_") ||
                t.startsWith("settings_") ||
                t.startsWith("last_viewed_") ||
                t.startsWith("widget_") ||
                t.startsWith("gatekeeper_")
              ? "system"
              : t === "world_books"
                ? "world_books"
                : t.startsWith("meet_app_")
                  ? "meet"
                  : t.startsWith("video_app_")
                    ? "video"
                    : t.startsWith("portable_")
                      ? "portable"
                      : t.startsWith("bubble_")
                        ? "bubble"
                        : t.startsWith("couple_")
                          ? "couple"
                          : t.startsWith("netease_")
                            ? "netease"
                            : t.startsWith("memory_archive_")
                              ? "memory_archive"
                              : t.startsWith("yesterday_bureau_")
                                ? "yesterday_bureau"
                                : t.startsWith("backstage_")
                                  ? "backstage"
                                  : t.startsWith("vinyl_")
                                    ? "vinyl"
                                    : t.startsWith("photo_frame_")
                                      ? "photo_frame"
                                      : t.startsWith("jilu_")
                                        ? "jilu"
                                        : t.startsWith("douyin_")
                                          ? "douyin_app"
                                          : t.startsWith("puzzle_")
                                            ? "puzzle"
                                            : t.startsWith("encounter_bazaar_")
                                              ? "encounter_bazaar"
                                              : t.startsWith("reading_app_")
                                                ? "reading_app"
                                                : t === "chat_app_chats"
                                                  ? "chat_sessions"
                                                  : Hee.has(t)
...
function e6(t) {
  return t.startsWith("arcade_") || t === "jilu_guest_id"
    ? "ls_others"
    : t === "chatApp_groupChatShortcut"
      ? "chat_contacts"
      : Zee(t)
        ? "chat_icity"
        : "ls_others";
...
function t6(t, s) {
  ...
  for (const [a, r] of Object.entries(t)) {
    if (a === "__localStorage_app_patch__") {
      const o = r;
...
const pg = [
    ...
    sections: [
      {
        id: "desktop_layout",
        label: "桌面布局与外观",
        hint: "主屏布局、桌面小组件数据、壁纸、应用图标定制、桌面风格、机壳与状态栏等",
      },
      {
        id: "system",
        label: "系统与设置",
        hint: "语言、字体、API、聊天预设、TTS、个人资料、小组件库预设、设备 ID、门禁记录等（不含主屏布局；导入时会自动跳过门禁关键键）",
      },
      { id: "world_books", label: "世界书", hint: "world_books" },
      { id: "mail", label: "邮件应用", hint: "邮箱设置与本地信件文件" },
    ],
  },
  {
    id: "apps",
    title: "其他应用",
    sections: [
      { id: "meet", label: "遇见", hint: "meet_app_*" },
      { id: "video", label: "视频", hint: "video_app_*" },
      { id: "portable", label: "随身 / 背包等", hint: "portable_*" },
      { id: "bubble", label: "气泡 / 艺术季刊", hint: "bubble_*" },
      { id: "couple", label: "情侣空间", hint: "couple_*" },
      { id: "netease", label: "网易云相关", hint: "netease_*" },
      { id: "memory_archive", label: "记忆归档", hint: "memory_archive_*" },
      { id: "yesterday_bureau", label: "昨日局", hint: "yesterday_bureau_*" },
      { id: "backstage", label: "后台故事", hint: "backstage_*" },
      { id: "vinyl", label: "黑胶档案", hint: "vinyl_*" },
      { id: "photo_frame", label: "照片相框", hint: "photo_frame_*" },
      { id: "jilu", label: "梅花 / 记录", hint: "jilu_*" },
      { id: "douyin_app", label: "抖音应用", hint: "douyin_*" },
      { id: "puzzle", label: "邮件拼图解锁", hint: "puzzle_*" },
      {
        id: "encounter_bazaar",
        label: "邂逅·匿名集市",
        hint: "encounter_bazaar_*（集市数据与聊天线程）",
      },
      {
        id: "reading_app",
        label: "阅读应用",
        hint: "reading_app_*（书架、笔记、进度、批注等）",
      },
    ],
  },
  {
    ...
    sections: [
      {
        id: "chat_sessions",
        label: "会话与消息",
        hint: "chat_app_chats（通常最大）",
      },
      {
        id: "chat_contacts",
        label: "联系人、分组、群与黑名单",
        hint: "contacts / groups / 好友请求等",
      },
      {
        id: "chat_summaries",
        label: "摘要与存档",
        hint: "summaries、archives",
      },
      {
        id: "chat_presets",
        label: "预设与表情包",
        hint: "预设、表情包、收藏、群布局预设",
      },
      {
        id: "chat_profile",
        label: "「我」与全局样式",
        hint: "用户资料、全局 CSS、夜间模式等",
      },
      { id: "chat_moments", label: "朋友圈", hint: "moments 与封面等" },
      {
        id: "chat_notify",
        label: "通知与提示音",
        hint: "系统通知、策略、音效键等",
      },
      {
        id: "chat_icity",
        label: "列表与 iCity 美化",
        hint: "聊天列表、小组件、列表背景等；含部分 localStorage",
      },
      {
        id: "chat_window_css",
        label: "聊天窗口 CSS 主题",
        hint: "chat_css_presets、chat_active_preset",
      },
      {
        id: "chat_extra",
        label: "通话 / 抖音记忆 / NPC 池",
      ...
      { id: "chat_drafts", label: "会话输入草稿", hint: "chat_app_drafts_*" },
      {
        id: "chat_audio",
        label: "聊天语音缓存",
        hint: "IndexedDB 中的语音文件",
      },
      {
        id: "chat_single_prompt",
        label: "单聊自定义预设库",
        hint: "IndexedDB 单聊预设",
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        id: "ls_others",
        label: "其他 localStorage",
        hint: "街机、访客 id 等非聊天补丁",
      },
      { id: "other_data", label: "未分类键", hint: "新版本可能新增的杂项键" },
    ],
  },
];
function Ro() {
  const t = {};
  for (const s of pg) for (const { id: n } of s.sections) t[n] = !0;
  return t;
}
function Xee() {
  const t = [];
  for (const s of pg) for (const { id: n } of s.sections) t.push(n);
  return t;
}
const m5 = pg.find((t) => t.id === "chat").sections.map((t) => t.id),
  L1 = "phone-full-backup-zip-v1",
  ete = (t) => {
    const s = new Uint8Array(t || new ArrayBuffer(0));
    let n = "";
    for (let a = 0; a < s.byteLength; a++) n += String.fromCharCode(s[a]);
    return btoa(n);
  },
  tte = ["chat_app_icity_", "chat_app_chatList_"],
  ste = new Set([
    "chatApp_groupChatShortcut",
    "chat_app_bg_image",
    "chat_app_debug_group_reply",
  ...
  nte = (t) => ste.has(t) || tte.some((s) => t.startsWith(s)),
  ate = (t) => t.startsWith("arcade_") || t === "jilu_guest_id";
async function rte() {
  if (typeof indexedDB > "u") return null;
  const t = "ChatApp_Audio",
    s = "audios_v2",
    n = 2,
    a = await new Promise((r, i) => {
      const o = indexedDB.open(t, n);
      ((o.onerror = () => i(o.error)),
        (o.onsuccess = () => r(o.result)),
        (o.onupgradeneeded = (c) => {
          const d = c.target.result;
          d.objectStoreNames.contains(s) || d.createObjectStore(s);
        }));
    });
  try {
    const r = await new Promise((i, o) => {
      const c = a.transaction(s, "readonly"),
        d = c.objectStore(s),
        u = d.getAllKeys();
      ((u.onerror = () => o(u.error)),
        (u.onsuccess = () => {
    ...
    return { version: 1, exportedAt: new Date().toISOString(), items: r };
  } finally {
    try {
      a.close();
    } catch {}
...
async function ite() {
  if (typeof indexedDB > "u") return null;
  const t = "july-ovo-single-custom-prompt-presets",
    s = 1,
    n = "presets",
    a = await new Promise((i, o) => {
      const c = indexedDB.open(t, s);
      ((c.onerror = () => o(c.error)),
